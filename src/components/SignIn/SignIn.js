...
class SignIn extends Component{
    ...
    onSubmitSignIn = ()=>{
        ...
        // if(e.target.value === 'Sign in' || e.target.code)
        
        fetch('https://evening-ridge-19704.herokuapp.com/signin', {
            method:'post',
            headers: {
        ...
        .then(userFromServer => {
            if (userFromServer.id){
                this.props.loadUser(userFromServer)
            ...
            <article className="br3 ba  b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
             <main className="pa4 black-80">
                <div className="measure ">
                    ...
                    <div className="mv3">
                        <label className="db fw6 lh-copy f6" htmlfFor="password">Password</label>
